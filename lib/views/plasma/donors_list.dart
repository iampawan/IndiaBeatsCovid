        ...
        return Card(
          ...
          child: Column(
            ...
            children: [
              ...
              MyRichText(title: "Pincode", value: donor.pincode?.toString()),
              MySelectableRichText(
                  title: "Phone", value: donor.phone?.toString()),
              MySelectableRichText(
                  title: "Alt Phone", value: donor.alternatePhone?.toString()),
              MyRichText(
                  title: "Submitted",
              ...
              if (!donor.lastVerifiedAt.isEmptyOrNull)
                [
                  MyRichText(
                      title: "Verified At",
                      value: Utils.getFormattedTime(donor?.lastVerifiedAt)),
                  10.widthBox,
                  const Icon(
